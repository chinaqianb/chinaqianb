package minecraftgtyf1.chinaqianbforge;
...
public class Chinaqianb_forge {

    // Define mod id in a common place for everything to reference
    public static final String MODID = "chinaqianb_forge";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "chinaqianb_forge" namespace


    public Chinaqianb_forge() {
